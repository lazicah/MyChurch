...
public abstract class MyBaseIndicatorBanner<E, T extends MyBaseIndicatorBanner<E, T>> extends MyBanner<E, T> {
    ...
    public MyBaseIndicatorBanner(Context context) {
        this(context, null, 0);
    }

    public MyBaseIndicatorBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyBaseIndicatorBanner(Context context, AttributeSet attrs, int defStyle) {
