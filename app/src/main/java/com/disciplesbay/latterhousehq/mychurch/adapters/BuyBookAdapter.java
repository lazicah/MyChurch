...
public class BuyBookAdapter extends RecyclerView.Adapter<BuyBookAdapter.ViewHolder> {
    ArrayList<Books> audioVideoArrayList;
    Activity activity;
    ...
    public BuyBookAdapter(ArrayList<Books> audioVideoArrayList, Activity activity) {
    ...
    public BuyBookAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new BuyBookAdapter.ViewHolder(cv);
    }

    @Override
    public void onBindViewHolder(final BuyBookAdapter.ViewHolder holder, final int position) {
        CardView cardView = holder.cardView;

        session = new SessionManager(activity);


        final Books audioVideo = audioVideoArrayList.get(position);


        TextView textView = (TextView) cardView.findViewById(R.id.name_of);
        textView.setText(audioVideo.getFilename());
    ...
    public void performCharge(final int position, final View view, final String cardNUmber, final String cvv, final int month, final int year) throws JSONException {
        ...
        charge.setReference(audioVideo.getFilename().toString().replaceAll("\\s+", "") + Calendar.getInstance().getTimeInMillis());
        try {
        ...
        customObj.put("productName", audioVideo.getFilename());
        ...
        PaystackSdk.chargeCard(activity, charge, new Paystack.TransactionCallback() {
            ...
            public void onSuccess(Transaction transaction) {
                ...
                i.putExtra("file_name", audioVideo.getFilename());
    ...
    private void verifyOnServer(final String trans, final int position) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    Books audioVideo = audioVideoArrayList.get(position);
    ...
    private void showDetails(View view, int position) {
        ...
        intent.putExtra("productName", audioVideo.getFilename());
