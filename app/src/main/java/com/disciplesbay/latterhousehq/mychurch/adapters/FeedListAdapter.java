...
import com.disciplesbay.latterhousehq.mychurch.data.FeedItem;
...
public class FeedListAdapter extends BaseAdapter {	
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView url = (TextView) convertView.findViewById(R.id.txtStatusMsg);
		...
		Testimony testimony = testimonyList.get(position);
